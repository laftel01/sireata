...
public class AtaView extends ListView {
	...
	private void excluirAtaNaoNull(Object idAta) throws Exception{
		AtaBO bo = new AtaBO();
	...
	private void publicarAtaNaoNull(Object idAta) throws Exception{
		AtaBO bo = new AtaBO();
